...
/**
 * Entry gate — balmingtiger gold full-bleed + wordmark + click to enter.
 * Room personality lives in the cartoon panorama, not a comic title card.
 */
    ...
    <>
      ...
      <div className="gate" ref={root} role="dialog" aria-label="Enter VCR Records">
        <div className="gate-inner" ref={inner}>
          ...
          <p className="gate-sub">Best experienced with audio on</p>
